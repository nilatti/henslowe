class Rehearsal < ActiveRecord::Base
  attr_accessible :start_time, :end_time, :act_id, :scene_id, :french_scene_id, :space_id, :production_id, :event_id, :days, :recurring, :start_date, :end_date, :actors
  attr_accessor :days, :recurring, :start_date, :end_date, :actors
 ...
 #   ids = [] 
  #  self.production.users.actor.uniq.each do |a|
