...
class TheatersControllerTest < ActionController::TestCase
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post :create, theater: { : @theater., mission_statement: @theater.mission_statement, name: @theater.name, state: @theater.state, street_address: @theater.street_address, website: @theater.website, zip: @theater.zip }
    end
  ...
  test "should update theater" do
    put :update, id: @theater, theater: { : @theater., mission_statement: @theater.mission_statement, name: @theater.name, state: @theater.state, street_address: @theater.street_address, website: @theater.website, zip: @theater.zip }
    assert_redirected_to theater_path(assigns(:theater))
  end
