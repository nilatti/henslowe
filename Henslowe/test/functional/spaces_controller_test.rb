...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { address: @space.address, name: @space.name, seating_capacity: @space.seating_capacity }
    end
  ...
  test "should update space" do
    put :update, id: @space, space: { address: @space.address, name: @space.name, seating_capacity: @space.seating_capacity }
    assert_redirected_to space_path(assigns(:space))
  end
